...
import { api, type Group, type Expense, type Settlement, type ChatMessage, type Member } from "@/lib/api";
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md text-center p-8">
          <div className="w-16 h-16 rounded-full bg-dabbu-red-bg flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-dabbu-red" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="flex items-center gap-3 h-16">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-dabbu-text-muted">
                {isConnected() ? (
            ...
            {expenses.length === 0 && (
              <div className="text-center py-12">
                <div className="w-16 h-16 rounded-2xl bg-dabbu-surface2 flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-dabbu-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
