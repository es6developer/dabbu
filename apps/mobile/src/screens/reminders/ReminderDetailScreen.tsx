...
const styles = StyleSheet.create({
  ...
  header: { margin: 20, padding: 28, borderRadius: 26 },
  ...
  actions: { flexDirection: 'row', flexWrap: 'wrap', padding: 22, gap: 10 },
  actionBtn: {
    paddingVertical: 18,
  ...
  modalOverlay: { flex: 1, justifyContent: 'center', padding: 44 },
  modalContent: { borderRadius: 28, padding: 28 },
  modalTitle: { fontSize: 19, fontWeight: '700', marginBottom: 20, textAlign: 'center' },
  snoozeOption: { paddingVertical: 18, borderBottomWidth: 1 },
  snoozeOptionText: { fontSize: 16, textAlign: 'center' },
  cancelBtn: { paddingVertical: 18, marginTop: 8 },
  cancelBtnText: { fontSize: 16, textAlign: 'center' },
});
