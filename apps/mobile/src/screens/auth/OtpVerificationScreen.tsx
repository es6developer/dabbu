...
export function OtpVerificationScreen() {
  ...
  return (
    <LinearGradient colors={isDark ? [colors.bg.secondary, colors.bg.primary] : ['#f8f4f0', colors.bg.primary]} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} style={styles.container}>
      ...
      <Text style={[styles.subtitle, { color: colors.text.tertiary }]}>Code sent to {email}</Text>
      ...
      <View style={styles.otpRow}>
        {otp.map((d, i) => (
          <TextInput
            ...
            style={[styles.otpInput, { backgroundColor: colors.bg.tertiary, borderColor: colors.border.subtle, color: colors.text.primary }]}
            value={d}
      ...
      <TouchableOpacity style={[styles.button, { backgroundColor: colors.accent.primary }, loading && styles.buttonDisabled]} onPress={handleVerify} disabled={loading}>
...
const styles = StyleSheet.create({
  ...
  otpInput: { width: 48, height: 56, borderRadius: 14, borderWidth: 1, textAlign: 'center', fontSize: 22, fontWeight: '700' },
