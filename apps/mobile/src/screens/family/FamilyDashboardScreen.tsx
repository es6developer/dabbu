        ...
        renderItem={({ item }) => (
          <View style={[styles.card, { backgroundColor: colors.bg.tertiary }]}>
            ...
            <View style={[styles.cardActions, { borderTopColor: colors.border.subtle }]}>
              ...
              >
                <View
                  style={[styles.actionIcon, { backgroundColor: `${colors.accent.primary}15` }]}
                >
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={[styles.emptyDesc, { color: colors.text.tertiary }]}>
              Create a family to share reminders and tasks
            </Text>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  emptyBtnText: { color: '#1A1528', fontSize: 15, fontWeight: '600' },
});
