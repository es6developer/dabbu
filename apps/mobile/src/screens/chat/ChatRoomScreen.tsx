            ...
            <View style={[styles.msgRow, isMine ? styles.msgRowMine : styles.msgRowOther]}>
              ...
              <View
                style={[
                  styles.msgBubble,
                  isMine
                    ? { backgroundColor: colors.accent.primary, borderBottomRightRadius: 4 }
                    : { backgroundColor: colors.bg.tertiary, borderBottomLeftRadius: 4 },
                ]}
              >
                {!isMine && (
                  <Text style={[styles.msgSender, { color: colors.accent.primary }]}>
...
const styles = StyleSheet.create({
  ...
  msgBubble: { maxWidth: '78%', padding: spacing.md, borderRadius: borderRadius['2xl'] },
  msgSender: { fontSize: 11, fontWeight: '600', marginBottom: spacing.xs },
  msgText: { fontSize: 15, lineHeight: 20 },
  msgTime: { fontSize: 10, color: 'rgba(255,255,255,0.5)', marginTop: spacing.xs, alignSelf: 'flex-end' },
  empty: { alignItems: 'center', paddingTop: spacing['6xl'] + spacing.xs, gap: spacing.sm },
  emptyText: { fontSize: 14 },
  typingText: { fontSize: 11, fontStyle: 'italic', paddingHorizontal: spacing.lg, paddingBottom: spacing.xs },
  inputBar: {
    flexDirection: 'row',
    alignItems: 'center',
