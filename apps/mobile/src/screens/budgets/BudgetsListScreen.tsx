...
const s = StyleSheet.create({
  ...
  emptySub: { fontSize: 14, textAlign: 'center', lineHeight: 20, marginBottom: spacing['2xl'] },
  emptyBtn: { borderRadius: borderRadius['2xl'], overflow: 'hidden' },
  emptyBtnGrad: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 24, paddingVertical: 14 },
  emptyBtnText: { color: '#FFF', fontSize: 15, fontWeight: '700' },
  summaryCard: { borderRadius: borderRadius['2xl'], padding: spacing.lg, marginBottom: spacing.md },
  summaryPeriod: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: spacing.sm },
  ...
  budgetPeriod: { fontSize: 11, fontWeight: '500' },
  budgetSpent: { fontSize: 15, fontWeight: '700' },
  budgetOf: { fontSize: 11, fontWeight: '500' },
