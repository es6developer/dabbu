  ...
  async function handleAddSavings() {
    ...
    try {
      ...
      const couple = Array.isArray(groups)
        ...
        : null;
      if (!couple) {
        throw new Error('No active couple space');
      }
          ...
          <View style={[styles.card, { backgroundColor: colors.bg.card }]}>
            ...
            <View style={styles.contribRow}>
              ...
              <View style={styles.contribInfo}>
                ...
                <Text style={[styles.contribAmount, { color: colors.text.secondary }]}>
                  {fmt(p1Contrib)}
                </Text>
              </View>
            </View>
            ...
            <View style={[styles.contribTotal, { borderTopColor: colors.border.default }]}>
              <Text style={[styles.contribTotalLabel, { color: colors.text.tertiary }]}>
                Total Contributions
              </Text>
              <Text style={[styles.contribTotalAmount, { color: colors.text.primary }]}>
                {fmt(p1Contrib + p2Contrib)}
              </Text>
            </View>
          </View>
                  ...
                  <View style={styles.ledgerLeft}>
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            entry.contributorId === partners?.partner1?.id
                    ...
                    <View style={styles.ledgerInfo}>
                      ...
                      {entry.note ? (
                        <Text style={[styles.ledgerNote, { color: colors.text.secondary }]}>
                          {entry.note}
                        </Text>
                      ) : null}
                    </View>
                  </View>
                  <Text style={[styles.ledgerAmount, { color: colors.status.success }]}>
                    +{fmt(entry.amount)}
                  </Text>
                </View>
              ))}
