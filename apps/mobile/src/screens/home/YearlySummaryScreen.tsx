...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 16, marginTop: 2, marginBottom: 20 },
  yearRow: { flexDirection: 'row', gap: 8 },
  yearChip: { paddingHorizontal: 24, paddingVertical: 8, borderRadius: 28, borderWidth: 1.5 },
  summaryCards: { flexDirection: 'row', paddingHorizontal: 24, gap: 8, marginBottom: 8 },
  statCard: { flex: 1, borderRadius: 28, padding: 18, alignItems: 'center' },
  ...
  barSegment: { height: 8, borderRadius: 8 },
  monthAmount: { fontSize: 12, width: 80, textAlign: 'right' },
  achievementGrid: { flexDirection: 'row', justifyContent: 'space-between' },
  achievementItem: { alignItems: 'center', gap: 4 },
  achievementValue: { fontSize: 19, fontWeight: '700', marginTop: 4 },
  achievementLabel: { fontSize: 12 },
  topCategoryRow: { flexDirection: 'row', alignItems: 'center', gap: 14 },
  categoryIcon: {
    width: 44,
    height: 52,
    borderRadius: 30,
  ...
  categoryAmount: { fontSize: 16, marginTop: 2 },
  categoryPercent: { fontSize: 19, fontWeight: '700' },
