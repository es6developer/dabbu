...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 16, fontWeight: '500', color: 'rgba(255,255,255,0.7)', marginTop: 4 },
  confidenceBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 14,
  ...
  confidencePct: { fontSize: 12, fontWeight: '500', marginTop: 1 },
  card: {
    borderRadius: 28,
    borderWidth: 1.5,
    padding: 22,
  ...
  categoryChipText: { fontSize: 16, fontWeight: '600' },
  sectionHeader: {
    flexDirection: 'row',
  ...
  addItemText: { fontSize: 16, fontWeight: '700' },
  itemRow: {
    flexDirection: 'row',
  ...
  ocrTitle: { fontSize: 16, fontWeight: '600', flex: 1 },
  ocrText: {
    fontSize: 12,
  ...
  buttonGroup: { paddingHorizontal: 24, marginTop: 6, paddingBottom: 24 },
  saveBtnWrap: {
    borderRadius: 30,
    overflow: 'hidden',
  },
