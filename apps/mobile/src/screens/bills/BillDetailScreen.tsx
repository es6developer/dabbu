...
export function BillDetailScreen() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        {bill && (
          <View style={[styles.confidenceBadge, { backgroundColor: `${getConfidenceColor(bill.confidence, colors)}22` }]}>
            <Ionicons name="shield-checkmark" size={14} color={getConfidenceColor(bill.confidence, colors)} />
            <Text style={[styles.confidenceText, { color: getConfidenceColor(bill.confidence, colors) }]}>
            ...
            {CATEGORIES.map((cat) => (
              <TouchableOpacity
                ...
                style={[
                  styles.categoryChip,
                  {
                    backgroundColor: category === cat ? `${colors.accent.primary}22` : colors.bg.tertiary,
        ...
        <TouchableOpacity
          style={[styles.saveBtn, { backgroundColor: colors.status.success, opacity: saving ? 0.6 : 1 }]}
          onPress={handleSave}
          disabled={saving}
        >
          {saving ? (
...
const styles = StyleSheet.create({
  ...
  confidenceBadge: {
    ...
    paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, marginBottom: 16,
  },
  ...
  textInput: { borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, fontWeight: '500' },
  textArea: { borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, minHeight: 80 },
  categoryScroll: { flexDirection: 'row', marginBottom: 4 },
  categoryChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, borderWidth: 1, marginRight: 8 },
  ...
  itemRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginBottom: 10, paddingBottom: 10, borderBottomWidth: 1 },
  itemFields: { flex: 1 },
  itemNameInput: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8, fontSize: 14, marginBottom: 6 },
  itemNumericRow: { flexDirection: 'row', gap: 8 },
  itemNumericInput: { flex: 1, borderRadius: 10, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8, fontSize: 14 },
  ...
  ocrText: { fontSize: 12, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', lineHeight: 18, paddingTop: 12, marginTop: 12, borderTopWidth: 1 },
  ...
  deleteBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 14, borderRadius: 16, borderWidth: 1, marginTop: 12 },
