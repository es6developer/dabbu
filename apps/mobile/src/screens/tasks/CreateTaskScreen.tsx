              ...
              >
                <Text
                  style={[
                    ...
                    category === c && { color: colors.accent.primary, fontWeight: '600' },
                  ]}
                >
                  {c}
                </Text>
              ...
              {familyMembers.map((m: any) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.chip,
                    { backgroundColor: colors.bg.secondary, borderColor: colors.border.subtle },
                    assignedTo === (m.userId || m.id) && {
                      backgroundColor: `${colors.accent.primary}18`,
                      borderColor: colors.accent.primary,
                    },
                  ]}
                  onPress={() =>
                    setAssignedTo(assignedTo === (m.userId || m.id) ? '' : m.userId || m.id)
                  }
                >
                  <Text
                    style={[
                  ...
                  >
                    {m.firstName || m.name || m.user?.firstName || 'Member'}
                  </Text>
                </TouchableOpacity>
              ))}
            </View>
          ) : (
            <Text style={[styles.noMembers, { color: colors.text.tertiary }]}>
