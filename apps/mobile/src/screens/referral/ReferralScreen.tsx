...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, RefreshControl, Share, Linking, Animated, Dimensions, Platform } from 'react-native';
...
const styles = StyleSheet.create({
  screen: { flex: 1 },
  hero: { paddingHorizontal: 28, paddingBottom: 44, alignItems: 'center' },
  heroEyebrow: {
    fontSize: 12,
    fontWeight: '700',
  ...
  codeText: { flex: 1, fontSize: 19, fontWeight: '800', color: '#FFF', letterSpacing: 2 },
  codeShare: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  codeShareText: { fontSize: 16, fontWeight: '700' },
  statsCard: {
    marginHorizontal: 20,
    marginTop: -24,
    borderRadius: 28,
  ...
  totalEarnedLabel: { fontSize: 16, fontWeight: '600' },
  totalEarnedValue: { fontSize: 26, fontWeight: '800' },
  ...
  referralName: { fontSize: 16, fontWeight: '600' },
  referralDate: { fontSize: 12, marginTop: 1 },
  statusBadge: { paddingHorizontal: 18, paddingVertical: 5, borderRadius: 24 },
  ...
  shareTitle: { fontSize: 19, fontWeight: '700', textAlign: 'center', marginBottom: 24 },
  ...
  shareCancel: { alignItems: 'center', paddingVertical: 18 },
