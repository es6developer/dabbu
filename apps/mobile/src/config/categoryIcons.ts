...
const LEGACY_ALIASES: [string, string, string][] = [
  ...
  ['Electricity', 'thunder', '#FDCB6E'],
  ['Gas', 'fire', '#FF6B6B'],
  ['Phone', 'phone', '#00B894'],
  ['Medical', 'medicinebox', '#FF4D4F'],
  ['Health', 'medicinebox', '#FF4D4F'],
  ['Health & Medical', 'medicinebox', '#FF4D4F'],
