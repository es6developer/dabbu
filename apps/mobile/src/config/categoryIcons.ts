...
export const INCOME_CATEGORIES: { name: string; icon: IonIconName; color: string }[] = [
  ...
  { name: 'Business', icon: 'storefront-outline', color: '#6366F1' },
  { name: 'Freelancing', icon: 'laptop-outline', color: '#3498DB' },
  { name: 'Investments', icon: 'trending-up-outline', color: '#9B59B6' },
...
const LEGACY_ALIASES: [string, string, string][] = [
  ...
  ['Gym', 'fitness-outline', '#A78BFA'],
  ['Fitness', 'fitness-outline', '#A78BFA'],
  ...
  ['Education', 'school-outline', '#6366F1'],
  ...
  ['Subscriptions', 'repeat-outline', '#6C5CE7'],
  ['Subscription', 'repeat-outline', '#6C5CE7'],
