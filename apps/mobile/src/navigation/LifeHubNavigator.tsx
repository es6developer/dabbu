...
const PLANNERS = [
  { name: 'House', icon: 'home', color: '#6366F1', description: 'Buy your dream home', screen: 'HousePlanner' },
  { name: 'Baby', icon: 'smileo', color: '#EC4899', description: 'Plan for your little one', screen: 'BabyPlanner' },
  { name: 'Retirement', icon: 'clockcircleo', color: '#F59E0B', description: 'Secure your future', screen: 'RetirementPlanner' },
  { name: 'Investment', icon: 'barschart', color: '#10B981', description: 'Grow your wealth', screen: 'InvestmentPlanner' },
  { name: 'Car', icon: 'car', color: '#3B82F6', description: 'Get your dream car', screen: 'CarPlanner' },
  { name: 'Education', icon: 'book', color: '#8B5CF6', description: 'Fund learning', screen: 'EducationPlanner' },
  { name: 'Vacation', icon: 'enviromento', color: '#14B8A6', description: 'Plan your getaway', screen: 'VacationPlanner' },
  { name: 'Wedding', icon: 'heart', color: '#F43F5E', description: 'Plan your big day', screen: 'WeddingPlanner' },
];
...
function LifeHubScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.bg.primary }]}>
      ...
      <Text style={[styles.subtitle, { color: colors.text.secondary }]}>Plan your life milestones</Text>
      <View style={styles.grid}>
        {PLANNERS.map((planner) => (
          ...
          >
            ...
            <Text style={[styles.cardDesc, { color: colors.text.tertiary }]}>{planner.description}</Text>
          </TouchableOpacity>
        ))}
      </View>
    </ScrollView>
