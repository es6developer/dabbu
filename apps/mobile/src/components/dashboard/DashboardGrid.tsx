  ...
  const persistLayout = useCallback(
    (order: WidgetType[]) => {
      ...
      saveTimerRef.current = setTimeout(() => {
        api
          .post(`/dashboard/widgets/reorder?scope=${mode}`, { widgetTypes: order })
          .catch(() => {})
          .finally(() => {
            setSaving(false);
          });
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerActions}>
              ...
              <TouchableOpacity
                ...
                style={[styles.editBtn, { backgroundColor: colors.bg.tertiary }]}
              >
                <AntDesign
                  name={editMode ? 'check' : 'setting'}
                  size={18}
            ...
            {editMode && (
              <View style={[styles.editBar, { backgroundColor: colors.bg.tertiary }]}>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.moveBtn,
                    { opacity: index === visibleWidgets.length - 1 ? 0.3 : 1 },
                  ]}
                >
