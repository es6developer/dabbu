...
const styles = StyleSheet.create({
  ...
  selectedText: { fontSize: 16, fontWeight: '600', flex: 1 },
  placeholder: { fontSize: 16, fontWeight: '500', flex: 1 },
  categoryDot: { width: 28, height: 28, borderRadius: 30, alignItems: 'center', justifyContent: 'center' },
  grid: { flexDirection: 'row', flexWrap: 'wrap' },
  gridItem: { alignItems: 'center', paddingVertical: 14, gap: 6 },
  gridIcon: {
    width: 54,
    height: 54,
    borderRadius: 32,
