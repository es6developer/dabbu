...
export class SubscriptionShareDto {
...
export class CreateSubscriptionDto {
  ...
  @ApiProperty({ example: 'Netflix Inc.' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(100)
  provider: string;
  ...
  @ApiPropertyOptional({ example: 'ott' })
  @IsString()
  @IsOptional()
  category?: string;
  ...
  @ApiProperty({ type: [SubscriptionShareDto] })
  @IsArray()
  @ArrayMinSize(1)
  @ValidateNested({ each: true })
  @Type(() => SubscriptionShareDto)
  shares: SubscriptionShareDto[];
}
