...
export class SubscriptionController {
  ...
  async getInvoices(@CurrentUser('id') userId: string, @Query() query: BillingHistoryQueryDto) {
  ...
  async createRazorpayOrder(@CurrentUser('id') userId: string, @Body('planId') planId: string) {
    ...
    const razorpayKeyId =
      this.configService.get<string>('RAZORPAY_KEY_ID') || 'rzp_test_placeholder';
    return {
      data: { order, key: this.razorpayService.isReady() ? razorpayKeyId : 'rzp_test_placeholder' },
    };
  }
