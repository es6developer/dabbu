...
const LENS_THEMES: Record<LensType, ThemeConfig> = {
  ...
  FAMILY: {
    ...
    gradientEnd: '#F0FDF4',
    darkPrimary: '#34D399',
    darkGradientStart: '#0A1A12',
    darkGradientEnd: '#0A0E0C',
    accentColor: '#34D399',
    successColor: '#22C55E',
    warningColor: '#F59E0B',
    errorColor: '#EF4444',
  ...
  FULL: {
    ...
    gradientEnd: '#FFFBEB',
    darkPrimary: '#FBBF24',
    darkGradientStart: '#1A1020',
    darkGradientEnd: '#0C0A0E',
    accentColor: '#D97706',
    successColor: '#22C55E',
    warningColor: '#F59E0B',
    errorColor: '#EF4444',
...
const LENS_DASHBOARDS: Record<LensType, { widgets: WidgetConfig[]; quickActions: QuickActionConfig[]; layout: string }> = {
  ...
  PARTNERED: {
    ...
    quickActions: [
      { key: 'add_shared_expense', label: 'Shared Expense', icon: 'addusergroup', color: '#F43F5E', sortOrder: 0, screen: 'AddSharedExpense' },
      ...
      { key: 'settle_balance', label: 'Settle Balance', icon: 'swap', color: '#3B82F6', sortOrder: 3, screen: 'SettleBalance' },
      { key: 'plan_expense', label: 'Plan Expense', icon: 'calendar', color: '#7C3AED', sortOrder: 4, screen: 'PlanExpense' },
    ],
    layout: 'single_column',
  },
  FAMILY: {
    ...
    quickActions: [
      { key: 'add_household_expense', label: 'Household Expense', icon: 'minuscircle', color: '#059669', sortOrder: 0, screen: 'AddHouseholdExpense' },
      { key: 'add_bill', label: 'Add Bill', icon: 'filetext', color: '#F59E0B', sortOrder: 1, screen: 'AddBill' },
      { key: 'add_goal', label: 'Add Goal', icon: 'flag', color: '#3B82F6', sortOrder: 2, screen: 'CreateFamilyGoal' },
      { key: 'record_allowance', label: 'Record Allowance', icon: 'gift', color: '#8B5CF6', sortOrder: 3, screen: 'Allowances' },
  ...
  FULL: {
    ...
    quickActions: [
      { key: 'add_expense', label: 'Add Expense', icon: 'minuscircle', color: '#EF4444', sortOrder: 0, screen: 'AddExpense' },
      { key: 'create_space', label: 'Create Space', icon: 'team', color: '#D97706', sortOrder: 1, screen: 'CreateSpace' },
      { key: 'add_goal', label: 'Add Goal', icon: 'flag', color: '#F59E0B', sortOrder: 2, screen: 'CreateGoal' },
      { key: 'export_report', label: 'Export Report', icon: 'barschart', color: '#22C55E', sortOrder: 3, screen: 'ExportReport' },
      { key: 'add_investment', label: 'Add Investment', icon: 'linechart', color: '#3B82F6', sortOrder: 4, screen: 'AddInvestment' },
    ],
    layout: 'single_column',
  },
};
